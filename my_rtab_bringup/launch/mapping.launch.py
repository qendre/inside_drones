...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'database_path',
            default_value=os.path.expanduser('~/berisha_ws/maps/default_map.db'), #change path if you want to save to a specific map
        ...
        Node(
            ...
            parameters=parameters,
            remappings=remappings,
            arguments=['-d']  #remove if you dont want to delete memory
        ),
        ...
        # RViz for mapping visualization
    	Node(
       	    package='rviz2',
       	    executable='rviz2',
       	    name='rviz2',
